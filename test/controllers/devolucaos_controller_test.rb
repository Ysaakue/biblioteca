...
class DevolucaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create devolucao" do
    assert_difference('Devolucao.count') do
      post devolucaos_url, params: { devolucao: { aluno_id: @devolucao.aluno_id, bibliotecario_id: @devolucao.bibliotecario_id, multa: @devolucao.multa } }
    end
  ...
  test "should update devolucao" do
    patch devolucao_url(@devolucao), params: { devolucao: { aluno_id: @devolucao.aluno_id, bibliotecario_id: @devolucao.bibliotecario_id, multa: @devolucao.multa } }
