...
class EmprestimosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create emprestimo" do
    assert_difference('Emprestimo.count') do
      post emprestimos_url, params: { emprestimo: { aluno_id: @emprestimo.aluno_id, bibliotecario_id: @emprestimo.bibliotecario_id, data_prev_ret: @emprestimo.data_prev_ret } }
    end
  ...
  test "should update emprestimo" do
    patch emprestimo_url(@emprestimo), params: { emprestimo: { aluno_id: @emprestimo.aluno_id, bibliotecario_id: @emprestimo.bibliotecario_id, data_prev_ret: @emprestimo.data_prev_ret } }
