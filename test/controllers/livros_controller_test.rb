...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference('Livro.count') do
      post livros_url, params: { livro: { editora_id: @livro.editora_id, exemplar: @livro.exemplar, publicacao: @livro.publicacao, titulo: @livro.titulo } }
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { editora_id: @livro.editora_id, exemplar: @livro.exemplar, publicacao: @livro.publicacao, titulo: @livro.titulo } }
