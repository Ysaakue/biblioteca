...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { livro_id: @reserva.livro_id, retirado: @reserva.retirado, user_id: @reserva.user_id } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { livro_id: @reserva.livro_id, retirado: @reserva.retirado, user_id: @reserva.user_id } }
